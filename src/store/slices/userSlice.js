...
export const register = (data) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://job-portal-grsh.onrender.com/api/v1/user/register", data, {
...
export const login = (data) => async (dispacth) => {
    ...
    try {
        const response = await axios.post("https://job-portal-grsh.onrender.com/api/v1/user/login", data, {
            withCredentials: true,
...
export const getUser = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get(
            "https://job-portal-grsh.onrender.com/api/v1/user/getuser",
            {
                withCredentials: true,
            }
        );
        ...
        dispatch(userSlice.actions.clearAllError());
         ...
         toast("LogIn For Batter Experience");
...
export const logout = () => async (dispatch) => {
    try {
        const response = await axios.get(
            "https://job-portal-grsh.onrender.com/api/v1/user/logout",
            {
                withCredentials: true,
            }
        );
